...
st.markdown(
    ...
    <style>
        ...
        .st-key-chat_messages [data-testid="stChatMessage"] p {
            margin: 0 !important;
            font-size: 13px !important;
            line-height: 1.5 !important;
        }
        
        /* 隐藏默认的 vertical block 边框 */
        .st-key-chat_container > [data-testid="stVerticalBlock"] {
            border: none !important;
            padding: 0 !important;
            gap: 0 !important;
            margin: 0 !important;
        ...
        .st-key-main_row [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar {
            width: 5px !important;
        }
        .st-key-chat_messages::-webkit-scrollbar-track,
        .st-key-main_row [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar-track {
            background: #f1f1f1 !important;
            border-radius: 3px !important;
        }
        .st-key-chat_messages::-webkit-scrollbar-thumb,
        .st-key-main_row [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar-thumb {
            background: #aaa !important;
            border-radius: 3px !important;
        }
        .st-key-chat_messages::-webkit-scrollbar-thumb:hover,
        .st-key-main_row [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar-thumb:hover {
        ...
        .st-subheader + div, .st-subheader + p {
...
st.markdown(
    ...
    <div style="text-align: center;">
        <h1 style="font-size: 24px; margin: 0; padding: 0;">🎓 教育实证研究全周期智能协同框架</h1>
        <p style="font-size: 13px; color: #555; margin: 2px 0 0 0; padding: 0;">ICFER - Intelligent Collaborative Framework for Empirical Research in Education</p>
    </div>
    """,
    unsafe_allow_html=True
)
...
if st.session_state.user_role == "研究者":
    ...
    with col_center:
        st.markdown("<h3 style='text-align: center; margin: 8px 0;'>📊 研究者数据导出</h3>", unsafe_allow_html=True)
        st.markdown(
            "<p style='text-align: center; margin: 0 0 8px 0; font-size: 13px;'>请输入研究者密码以查看并下载数据</p>",
            unsafe_allow_html=True
        )
    ...
    if st.session_state.experiment_completed:
        st.markdown(
            ...
            <div style="text-align: center; padding: 30px 20px;">
                <h2 style="color: #4CAF50; margin: 0 0 10px 0;">✅ 方案已提交成功！实验已完成！</h2>
                <p style="font-size: 16px; margin: 5px 0;">感谢您参与本次研究！您的数据已成功保存。</p>
                <p style="font-size: 14px; color: #666; margin: 5px 0;">您现在可以关闭此页面，或点击下方按钮返回首页。</p>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    if not st.session_state.participant_id:
        st.markdown(
            ...
            <div style="text-align: center; padding: 40px 20px;">
                <h2 style="color: #1a3a5a; margin: 0 0 8px 0; font-size: 22px;">👤 欢迎参与研究</h2>
    ...
    if not st.session_state.consent_given:
        st.markdown(
            "<p style='text-align: center; font-size: 14px; color: #555; margin: 4px 0 8px 0;'>"
        ...
        st.markdown(
            ...
            <div class="consent-card">
                <h2>📋 知情同意书</h2>
                <p style="text-align:center; color:#888; font-size:12px; margin:0 0 10px 0;">版本号：v1.0_ICFER_2026 | 生效日期：2026-09-20</p>
...
<p><strong></strong><br</p>
                ...
                <p>本研究致力于探索教育研究者（如您）在实际科研工作中如何与生成式人工智能（AI）协同工作。我们将通过观察您与 AI 共同完成一项研究设计任务的过程，来分析您的行为模式、思维过程及主观感受。最终，本研究的成果将有助于制定更负责任、更可解释的 AI 使用指南，为高校和相关机构的科研培训提供依据。</p>
...
<p><strong></strong><br</p>
                ...
                <p><strong>会的。</strong> 研究结束后，我们承诺在不泄露个人隐私的前提下，通过电子邮件等方式向有需要的参与者分享一份总体研究发现摘要，以及负责任使用 AI 的实践建议。您可以在知情同意时自主选择是否接收研究结果。</p>
<p><strong></strong><br</p>
                <p><strong>七、如有疑问可以联系谁？</strong></p>
                <div class="contact-box">
                    <p style="margin:0 0 6px 0;">如果您对本次研究有任何疑问、顾虑，或在参与过程中遇到任何问题，欢迎随时联系我们的研究负责人：</p>
                    <ul style="margin:0;">
        ...
        with st.container(key="main_row"):
            ...
            with col_left:
                ...
                with st.container(key="chat_container"):
                    ...
                    # 输入表单区域（固定在底部）
                    with st.container(key="input_area"):
