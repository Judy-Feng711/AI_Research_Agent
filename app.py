...
st.markdown(
    ...
    <style>
        ...
        .messages-area [data-testid="stChatMessage"] {
            margin-bottom: 6px !important;
            padding: 6px 10px !important;
        }
        .messages-area [data-testid="stChatMessage"] p {
            margin: 0 !important;
            font-size: 13px !important;
        ...
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn {
        ...
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn:first-child {
            padding-right: 6px !important;
        }
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn:last-child {
        ...
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar {
            width: 5px !important;
        }
        .messages-area::-webkit-scrollbar-track,
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar-track {
            background: #f1f1f1 !important;
            border-radius: 3px !important;
        }
        .messages-area::-webkit-scrollbar-thumb,
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar-thumb {
            background: #aaa !important;
            border-radius: 3px !important;
        }
        .messages-area::-webkit-scrollbar-thumb:hover,
        .main-container [data-testid="stHorizontalBlock"] > div.stColumn:last-child::-webkit-scrollbar-thumb:hover {
...
st.markdown(
    ...
    <div style="text-align: center;">
        <h1 style="font-size: 22px; margin: 0; padding: 0;">🎓 教育实证研究全周期智能协同框架</h1>
...
if st.session_state.user_role == "研究者":
    ...
    if not st.session_state.participant_id:
        st.markdown(
            ...
            <div style="text-align: center; padding: 40px 20px;">
                <h2 style="color: #1a3a5a; margin: 0 0 6px 0; font-size: 20px;">👤 欢迎参与研究</h2>
    ...
    if not st.session_state.consent_given:
        st.markdown(
            "<p style='text-align: center; font-size: 13px; color: #555; margin: 3px 0 6px 0;'>"
        ...
        st.markdown(
            ...
            <div class="consent-card">
                <h2>📋 知情同意书</h2>
                <p style="text-align:center; color:#888; font-size:11px; margin:0 0 8px 0;">版本号：v1.0_ICFER_2026 | 生效日期：2026-09-20</p>
    ...
    if st.session_state.participant_id:
        ...
        with st.container(key="main_container"):
            ...
            with col_left:
                ...
                # 聊天容器：使用 flex 布局，最大化高度
                with st.container(key="chat_wrapper"):
                    # 聊天消息区域（可滚动）
                    with st.container(key="messages_area"):
                        has_dialogue = False
