...
st.markdown(
    ...
    <style>
        ...
        .left-column {
            ...
            padding: 15px;
            box-shadow: 0 2px 8px rgba(100, 130, 160, 0.08);
        }
        ...
        .right-column {
            ...
            border-radius: 12px;
            border: 1px solid #d5e4c5;
            padding: 15px;
            box-shadow: 0 2px 8px rgba(130, 160, 100, 0.08);
...
if st.session_state.user_role == "研究者":
    ...
    if not st.session_state.consent_given:
        ...
        st.markdown(
            ...
            <div class="consent-card">
                ...
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本研究致力于探索教育学及相关专业的硕士、博士研究生在实际科研工作中如何与生成式人工智能（AI）协同工作。我们将通过观察您与 AI 共同完成一项研究设计任务的过程，来分析您的行为模式、思维过程及主观感受。</p>
                ...
                <div class="contact-box">
                    <p style="margin:0 0 5px 0;">研究负责人：周榕 副教授（rzhou@snnu.edu.cn，13309296061）</p>
                </div>
    ...
    if st.session_state.participant_id:
        ...
        with col_left:
            ...
            with st.container():
                ...
                with st.form(key="prompt_form", clear_on_submit=True):
                    ...
                    st.markdown("👇 **请选择提交行为：**")
                    st.markdown('<div class="behavior-buttons">', unsafe_allow_html=True)
                    col_b1, col_b2, col_b3, col_b4, col_b5 = st.columns(5)
                    clicked_behavior = None
                    if col_b1.form_submit_button("获取基础信息"):
                        clicked_behavior = "获取基础信息"
                    if col_b2.form_submit_button("规范语言/格式"):
                        clicked_behavior = "规范语言/格式"
                    if col_b3.form_submit_button("微调研究逻辑"):
                        clicked_behavior = "微调研究逻辑"
                    if col_b4.form_submit_button("重构研究方案"):
                        clicked_behavior = "重构研究方案"
                    if col_b5.form_submit_button("拓展研究思路"):
        ...
        with col_right:
            ...
            st.caption("任务共分为 6 个递进环节，请根据您与 AI 的完整对话，将各环节的核心成果填入下方对应模块。")
