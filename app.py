...
INITIAL_GREETING = (
    '您好！我是您的教育研究全栈助理 ICFER。我们将围绕 '
    '"人工智能时代的教师教育与教师专业发展研究" 这一主题，'
    '结合您的学科专长，一起完成一份实证研究设计方案。'
    '请告诉我，您想从哪个具体的研究切入点开始？'
)
...
st.markdown(
    ...
    <style>
        ...
        /* ========================================
           主实验左右双栏
           只选择同时包含左右两个 h3 标题的外层布局
           ======================================== */

        /* 最外层左右双栏 */
        .st-key-main_row
        [data-testid="stHorizontalBlock"]
        :has(> div.stColumn:first-child h3)
        :has(> div.stColumn:last-child h3) {
...
st.markdown(
    ...
    <div style="text-align: center;">
        ...
        <p style="font-size: 20px; color: #555; margin-top: 4px;">
            Intelligent Collaborative Framework for Empirical
            Research in Education (ICFER)
        </p>
    </div>
    """,
    unsafe_allow_html=True
        ...
        if not st.session_state.export_authorized:
            ...
            with col_btn2:
                if st.button(
                    ...
                    researcher_password = st.secrets.get(
                        "RESEARCHER_PASSWORD",
                        "MyPassword123"
                    )

                    if export_pass == researcher_password:
    ...
    if not st.session_state.consent_given:
        ...
        st.markdown(
            ...
            <div class="consent-card">
                ...
                <p>
                    <strong>
                        研究主题：人工智能辅助教育研究的特征与机制研究
                    </strong>
                </p>

                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    您已完成本研究的问卷阶段。本页为研究第二阶段的
                    补充知情说明，请您阅读后决定是否继续参与人机交互任务。
                </p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    尊敬的参与者，您好！我们是陕西师范大学教育学部的
                    科研团队，诚挚地邀请您参与我们的研究项目。
                    在您点击“同意”按钮之前，请务必仔细阅读以下内容，
                    以确保您充分了解本研究的目的、流程、潜在风险与收益，
                    以及您的各项权利。如有任何疑问，欢迎随时与我们联系。
                </p>

                <br>

                <p>
                    <strong>一、这项研究是关于什么的？</strong>
                </p>

                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    本研究致力于探索教育学及相关专业的硕士、博士研究生
                    在实际科研工作中如何与生成式人工智能（AI）协同工作。
                    我们将通过观察您与 AI 共同完成一项研究设计任务的过程，
                    来分析您的行为模式、思维过程及主观感受。
                    最终，本研究的成果将有助于制定更负责任、
                    更可解释的 AI 使用指南，为高校和相关机构的科研培训
                    提供依据。
                </p>
                ...
                <p>
                    ...
                    <strong>
                        ...
                        Intelligent Collaborative Framework for
                ...
                <p>
                    ...
                    在对话中，您将围绕统一主题
                    <strong>
                        “人工智能时代的教师教育与教师专业发展研究”
                    </strong>
                    ，结合您自身的学科专长（如学科教学、教育技术、
                    教育管理等），从中选定一个具体的研究切入点，
                    并在 ICFER 的辅助下构思并完成一份完整的
                    实证研究设计方案。
                </p>
                ...
                <p>
                    ...
                    这项设计任务是实验环节中的一次模拟任务，
                    您所完成的设计方案仅用于本研究分析，
                    不会用于课程评价、科研考核、职称评定或真实学术成果提交。
                    实验中使用的材料均为统一编撰并经过脱敏处理，
                    不要求您提交个人真实论文、未公开数据、评审材料或其他
                    涉及个人、单位及科研保密的信息。
                </p>
                ...
                <p>
                    <strong>二、参与过程会发生什么？</strong>
                </p>

                <ul>
                    <li>
                        <strong>深度人机对话</strong>：
                        您将与 ICFER 围绕上述统一主题下您所聚焦的
                        具体研究问题进行自由、深入的探讨。
                        ICFER 会尝试辅助您梳理思路、提供建议、
                        完善研究设计。
                    </li>

                    <li>
                        <strong>方案构思与生成</strong>：
                        在 ICFER 的辅助下，您需要在系统中逐步填写
                        研究设计的关键要素（如研究问题、研究方法、
                        数据收集与分析计划等），最终形成一份属于您自己的
                        研究方案初稿。
                    </li>
                ...
                <p>
                    <strong>三、我的数据会被怎么处理？安全吗？</strong>
                </p>
                ...
                <ul>
                    <li>
                        <strong>用途限定</strong>：
                        所有收集的数据
                        <strong>仅用于本项目的学术分析</strong>，
                        不会用于任何商业目的，也不会被用于训练 AI 模型。
                    </li>

                    <li>
                        <strong>匿名化处理（去标识化）</strong>：
                        在分析前，所有数据（包括对话日志）都将进行严格的
                        匿名化处理，即删除您的姓名、联系方式、单位等
                        可直接识别您身份的信息。
                        最终公开发表的研究成果中，仅会呈现无法识别个体的
                        引语或任务示例。
                    </li>

                    <li>
                        <strong>安全存储</strong>：
                        原始电子数据将加密存储于受权限控制的学校服务器
                        或加密存储设备中。
                    </li>
                    ...
                    <li>
                        ...
                        您在本阶段获得的编号，将用于将您的对话数据与
                        您此前参与研究时产生的数据进行关联分析。
                        您报名时留下的联系方式仅用于研究协调与邀请，
                        不会与您的对话数据一并存储。
                        在数据分析开始前，联系方式将被删除，仅保留随机编号。
                    </li>
                </ul>
                ...
                <p>
                    <strong>四、参与这项研究有什么风险或收益吗？</strong>
                </p>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                为保障您的科研信息安全，请
                                <strong>勿</strong>
                                在研究过程中向 AI 输入您未发表的论文正文、
                                未公开数据、评审材料或带有单位信息的保密内容。
                                确需使用 AI 平台时，请避免输入真实姓名、
                                联系方式、未公开研究成果、个人敏感信息、
                                保密数据或具有识别性的他人资料。
                            </li>
                ...
                <p>
                    ...
                    通过电子邮件等方式向有需要的参与者分享一份
                    总体研究发现摘要，以及负责任使用 AI 的实践建议。
        ...
        with col_center_btn:
            if st.button(
                ...
                consent_saved = save_consent_record(
                    st.session_state.participant_id
                )
        ...
        with st.container(key="main_row"):
            ...
            with col_right:
                ...
                with st.form(key="plan_form"):
                    ...
                    col_submit_btn_left, col_submit_btn_right = (
                        st.columns([3, 1])
                    )
