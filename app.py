...
if st.session_state.user_role == "研究者":
    ...
    if not st.session_state.consent_given:
        st.markdown(
            ...
            "您好！我是您的AI教育研究专属学术助手，聚焦于“人工智能时代的教师教育与教师专业发展研究”这一核心议题。结合您的学科专长，我将与您共同推进这一前沿课题的研究，为您提供深度支持。"
            "请告诉我您当前的具体需求——无论是文献梳理与理论Gap挖掘、研究设计与方法论推演，还是数据分析支持、论文初稿模拟审稿，我都在这里。期待与您开启对话。😊"
            "</p>",
            unsafe_allow_html=True
        )
